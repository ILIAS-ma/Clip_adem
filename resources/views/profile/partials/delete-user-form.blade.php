<section x-data="{ open: false }">
    <header>
        <h2 class="font-display text-lg font-bold text-ink-50">Supprimer mon compte</h2>
    ...
    <div x-show="open" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-ink-950/80 p-4"
         @keydown.escape.window="open = false">
        <div class="card w-full max-w-md p-6" @click.outside="open = false">
            <h3 class="font-display text-lg font-bold text-ink-50">Confirmer la suppression</h3>
            <p class="mt-2 text-sm text-ink-300">Saisissez votre mot de passe pour confirmer.</p>
