        ...
        <section x-data="{ mobileNavOpen: false }"
            ...
            <div class="relative z-10 mx-auto max-w-3xl px-6 pb-24 pt-20 text-center sm:pb-32 sm:pt-28">
                ...
                {{-- Bandeau de plateforme supportée.
                     ...
                     C’est un lien, pas un logo : la pastille s’éclairait au survol
                     comme un bouton alors qu’elle ne menait nulle part. Cliquer
                     dessus est une intention d’inscription — autant l’emmener là
                ...
                <div class="animate-fade-slide-in-4 mx-auto mt-16 max-w-lg border-t border-ink-800/80 pt-10">
                    ...
                    <div class="mt-5 flex items-center justify-center">
                        <a href="{{ route('register') }}"
                           aria-label="Créer un compte pour publier depuis TikTok"
                           class="flex h-12 w-full max-w-[10rem] items-center justify-center gap-2 rounded-full text-ink-200 ring-1 ring-ink-800 transition-all hover:text-ink-50 hover:ring-brand-500/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-400">
