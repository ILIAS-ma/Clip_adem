...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        ...
        /*
         * Plafond relevé à 512 Mo (la valeur est en kilo-octets).
         *
         * Le défaut de Livewire est 12 Mo : un rush vidéo déposé dans le brief
         * d'une campagne était refusé avant même d'atteindre la validation de
         * Filament, avec un message qui ne disait pas pourquoi. Le contrôle
         * fin — extensions et poids par type de pièce — reste fait par
         * AssetKind ; celui-ci n'est qu'un garde-fou de dernier recours.
         *
         * PHP doit suivre : `upload_max_filesize` et `post_max_size` au moins
         * aussi hauts dans php.ini, sinon la requête est coupée en amont.
         */
